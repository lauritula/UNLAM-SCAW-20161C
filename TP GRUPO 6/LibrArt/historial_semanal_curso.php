...
echo "<script language='JavaScript' src='js/historial_semanal_curso.js'></script> ";
...
$productos = ejecutar_sql($squery);
	...
	echo "<form method='post' action='historial_semanal_curso.php' name='hisSemCurso' id='hisSemCurso'>";
	echo "<h3>Historial de Precios de la semana en curso</h3>";
